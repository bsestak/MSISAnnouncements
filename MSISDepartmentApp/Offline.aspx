<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Offline.aspx.cs" Inherits="MSISDepartmentApp.Offline" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <img src="../images/PeteOffline.png" class="mx-auto img-fluid d-block" />
                </div>
            </div>
        </div>
    </form>
